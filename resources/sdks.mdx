...
<CardGroup cols={2}>
  ...
  <Card title="Python" icon="python" href="/quickstart/python/send-with-python">
    ```bash
    pip install lettr
    ```
  </Card>
  ...
  <Card title="Go" icon="golang" href="/quickstart/go/send-with-go">
    ```bash
    go get github.com/lettr-com/lettr-go
    ```
  </Card>
  <Card title="Java" icon="java" href="/quickstart/java/send-with-java">
    ```xml
    <dependency>
