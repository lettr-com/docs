---
title: Campaigns
description: "List, inspect, send, schedule, and unschedule email campaigns from Laravel using the Lettr facade and the campaigns API"
---
...
<CardGroup cols={2}>
  <Card title="Audience" icon="users" href="/quickstart/laravel/audience">
