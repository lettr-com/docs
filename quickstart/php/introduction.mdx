...
description: "Send transactional emails from any PHP app with the type-safe lettr/lettr-php SDK, featuring a fluent builder and typed error handling."
---
...
<Steps>
  <Step title="Install the package">
    ...
    The package requires PHP 8.4+ and Guzzle 7.5+ or 8.x. Composer will install Guzzle automatically if it's not already in your project.
  </Step>
