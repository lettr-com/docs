...
<Note>
  If you're using Laravel or Symfony, consider using the framework-specific SDK instead for deeper integration: [Laravel SDK](/quickstart/laravel/introduction) | [Symfony Bridge](/quickstart/php/symfony)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Symfony" icon="symfony" href="/quickstart/php/symfony">
    Symfony Mailer transport integration
  </Card>
...
| [Templates](/quickstart/php/templates) | Managing Lettr templates, versioning, projects, and retrieving merge tags |
