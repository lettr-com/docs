...
description: "Send emails with the Lettr PHP SDK using quick send methods, the fluent email builder, templates with substitution data, and attachments."
---
...
For more advanced template usage including versioning, see the [Templates](/quickstart/php/templates) page.
...
The `useTemplate()` method accepts an optional `version` parameter to pin a specific template version. See [Templates](/quickstart/php/templates) for details.
