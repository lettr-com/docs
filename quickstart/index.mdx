...
<Tip>
  Working with an AI coding assistant like Claude Code or Cursor? Connect the [Lettr MCP server](/learn/mcp/introduction) and your assistant can send test emails, create templates, and set up domains for you while you integrate.
</Tip>
...
<Note>
  No verified domain yet? Create a [sandbox API key](/learn/api-keys/sandbox) instead and skip step 3 — sandbox sends go out from a pre-verified sandbox domain and land in your own inbox, so you can complete any quickstart on this page before setting up DNS.
</Note>
