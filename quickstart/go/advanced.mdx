---
title: Advanced
description: "Advanced Lettr Go SDK usage including CC and BCC, reply-to, attachments, templates, batch sending, and error handling."
---
...
```go
import "errors" // stdlib, for errors.As
