...
<Note>
  New to the Lettr Python SDK? Start with the [Python Quickstart](/quickstart/python/send-with-python) to learn the basics, then return here for Flask-specific integration patterns.
</Note>
