...
description: "List, create, update, and delete webhook endpoints with the Lettr Python SDK to receive real-time email event notifications."
---
...
Pass only the fields you want to change (at least one):
