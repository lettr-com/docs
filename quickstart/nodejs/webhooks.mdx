...
description: "Manage webhook endpoints for delivery, open, click, bounce, and spam events with the client.webhooks resource in the Lettr Node.js SDK."
---
...
All fields are optional — only the ones you set are sent. Set at least one; an empty update is rejected:
