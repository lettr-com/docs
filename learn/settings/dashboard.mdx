...
<Tip>
  If you haven't finished all checklist items yet, the dashboard is the best place to pick up where you left off. Each checklist item links directly to the relevant setup page, so you don't have to hunt for the right section in the documentation.
</Tip>
