...
When you change your password, all other active sessions are automatically invalidated. You remain logged in on the device where you changed your password, but any other sessions (other browsers, other devices) are signed out and require re-authentication.
