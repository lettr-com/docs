---
title: Onboarding
description: "Set up your Lettr team with the four-step onboarding wizard covering company basics, details, branding, and an email template style"
---
...
<Note>
  Accounts with [Adamko](/learn/ai-assistant/introduction), Lettr's AI assistant, enabled skip the wizard below entirely — Adamko handles onboarding in the chat instead, building your brand kit, templates, sending domain, and API key in one [guided setup flow](/learn/ai-assistant/onboarding-and-setup). Adamko is rolling out gradually; if your account doesn't have him yet, the wizard below is what you'll see.
</Note>
