...
description: "The hosted Manage Email Preferences page every unsubscribe link opens: topic choices, a 30/60/90-day pause, a global unsubscribe with reasons, and recent emails, shown in the contact's language"
---
...
The page is translated. It opens in each contact's own language, so a German contact unsubscribes and manages preferences in German while a French contact on the same list sees French. This covers everything Lettr renders on the page, including the unsubscribe dialog and the confirmation afterwards.

The page is available in 19 languages and picks one in this order:

1. The contact's [communication language](/learn/multilingual-campaigns/contact-language), when it is one of the 19 languages.
