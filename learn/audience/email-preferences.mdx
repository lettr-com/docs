...
The page renders in the contact's [communication language](/learn/multilingual-campaigns/contact-language), so a Czech recipient of a Czech-language team sees it in Czech.
