---
title: Segments
description: "Build dynamic contact groups defined by conditions that update automatically as contact data and subscriptions change"
---
...
| `is_empty` | The contact has no value for the property | Any custom property |
| `is_not_empty` | The contact has a value for the property | Any custom property |
...
<Note>
  Not sure what to segment on in the first place? After a contact import, ask [Adamko](/learn/ai-assistant/audience-and-imports#segment-suggestions) *"how should I segment these contacts?"* — he analyzes the imported columns and proposes segments with names, starting conditions, and reasoning, then hands you off to this builder to create them.
</Note>
