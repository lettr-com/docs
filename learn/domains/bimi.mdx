...
BIMI allows your verified brand logo to appear next to your emails in supported email clients. This increases brand recognition, builds trust with recipients, and helps your emails stand out in crowded inboxes.

## What is BIMI?

BIMI is an email specification that links your authenticated domain to a verified brand logo. When you send an email, participating email clients display your logo next to your message.

<Info>
  When BIMI is configured, your brand logo appears as a small avatar or icon next to your emails in supported email clients like Gmail and Yahoo Mail, similar to how a profile picture appears next to messages in a chat application.
</Info>

### Benefits

- **Brand Recognition** - Your logo appears prominently in the inbox
- **Increased Trust** - Recipients know emails are legitimately from you
- **Higher Engagement** - Branded emails have higher open rates
- **Spam Differentiation** - Stand out from phishing attempts
...
<Note>
  Clients without VMC requirement may display logos from the BIMI record even without a certificate, but coverage is limited.
</Note>
