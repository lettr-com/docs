...
When you add a new sending domain, Lettr automatically evaluates it for approval. The scoring considers:

- **Domain age** — Older, established domains score higher
- **Domain characteristics** — Standard TLDs and conventional naming patterns
- **Active website** — Whether the domain hosts a website with legitimate content

Domains meeting the approval threshold are approved automatically. If your domain remains in `pending` or `blocked` status, contact support for manual review.
