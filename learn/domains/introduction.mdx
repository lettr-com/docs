...
description: "Configure and verify the four domain types Lettr supports for sending, tracking, receiving, and storing email assets on your own domain"
---
...
<Tip>
  [Adamko](/learn/ai-assistant/introduction), Lettr's AI assistant, can register the domain for you (*"add mail.example.com as a sending domain"*), guide you through the DNS setup step by step on the domain page, and [diagnose verification problems](/learn/ai-assistant/troubleshooting-and-diagnostics#domain-verification-problems) with live DNS lookups when a record won't validate.
</Tip>
...
<Note>
  Verified domains stay monitored: a daily [DNS health check](/learn/settings/alerts#domain-dns-health-alerts) watches every verified domain and warns you — in-app, and optionally by email or webhook — if a DNS record later stops resolving. Monitoring is informational only; it never blocks your sending.
</Note>
