...
console.log({
  dmarcStatus: domain.dmarcStatus,     // 'verified', 'pending', 'not_found'
  dmarcPolicy: domain.dmarcPolicy,     // 'none', 'quarantine', 'reject'
  dmarcRecord: domain.dmarcRecord      // Full DMARC record
});
```
