...
description: "Set up MX records to receive incoming email through Lettr, capturing replies and triggering webhooks for support and automation workflows"
---
...
<Tip>
  Want to test inbound processing before touching your DNS? Every team gets a dedicated [sandbox inbox](/learn/inbound/sandbox) — send an email to your sandbox address and inspect it in the dashboard, no MX records required.
</Tip>
