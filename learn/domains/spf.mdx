...
| `include:spf.lettr.dev` | Authorize Lettr's mail servers |
...
```
v=spf1 include:spf.lettr.dev include:spf.protection.outlook.com include:servers.mcsv.net ~all
```
...
| Emails still failing | Check that Lettr's include is present: `include:spf.lettr.dev` |
