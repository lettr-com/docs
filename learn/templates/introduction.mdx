...
description: "Create, manage, and organize reusable email templates in Lettr, then send them by referencing a template slug from your application."
---
...
<Tip>
  You don't have to start from a blank canvas. [Adamko](/learn/ai-assistant/content-creation), Lettr's AI assistant, can scaffold branded transactional templates (welcome, password reset, invoice, and more) or build a custom design from a plain-language description — every result opens in the editor as a normal template you refine like any other.
</Tip>
...
You can also manage templates through an AI assistant: both [Lettr MCP servers](/learn/mcp/introduction) expose tools to list, inspect, create, and update templates, so you can say "create a password-reset template with our brand colors" instead of writing HTML by hand.
