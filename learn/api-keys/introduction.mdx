...
<Tip>
  If [Adamko](/learn/ai-assistant/introduction) is enabled in your account, you can also just ask him — *"create an API key named production"* — and he creates it and hands you the key in a copy-once card. Key creations made this way appear in [Adamko's activity log](/learn/ai-assistant/activity-log-and-undo), where they can be revoked with one click.
</Tip>
