...
You can retrieve tracking data for any email through the API. The response includes aggregate counts (total opens, total clicks) and timestamps for the first and last engagement:
