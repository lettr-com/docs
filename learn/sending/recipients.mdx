...
When validation fails, the API returns an error and the email is not sent:
...
// Suppressed address
{
  ...
  "error": {
    ...
    "message": "Recipient 'bounced@example.com' is on your suppression list."
  }
}
...
// Too many recipients
{
  ...
  "error": {
    ...
    "message": "Total recipients (to + cc + bcc) cannot exceed 50."
  }
}
```
