---
title: Introduction
description: "Protect your sender reputation by managing suppressed addresses in Lettr that have bounced, complained, or unsubscribed from your emails."
---
...
<Tip>
  For a quick one-off check, ask [Adamko](/learn/ai-assistant/troubleshooting-and-diagnostics): *"is jane@acme.com suppressed?"* — he checks the suppression list, tells you why the address was suppressed and when, and can diagnose the underlying delivery problem in the same conversation.
</Tip>
