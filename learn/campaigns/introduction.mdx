---
title: Campaigns
description: "Send marketing emails to your audience as one-time bulk sends, then track delivery and engagement after the campaign goes out"
---
...
One content can still reach people in several languages. When the campaign's template has more than one language, each recipient gets the version that matches their contact's language property. See [Multilingual Campaigns](/learn/multilingual-campaigns/introduction).
...
<CardGroup cols={3}>
  ...
  <Card title="Send in several languages" icon="languages" href="/learn/multilingual-campaigns/introduction">
    One campaign, one audience, every recipient in their language
  </Card>
</CardGroup>
