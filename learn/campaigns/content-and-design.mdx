...
You can link a campaign to one of your [templates](/learn/templates/introduction) instead of writing content directly. To link, choose **Use template** in the Compose step and pick a marketing template — one that lives in your Marketing mode. If the design you want only exists as a transactional template, use its **Copy to Marketing** action first to create a marketing copy (see [Transactional vs. Marketing Templates](/learn/templates/projects#transactional-vs-marketing-templates)).
