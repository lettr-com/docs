...
In a [multilingual campaign](/learn/multilingual-campaigns/sending-and-results#the-unsubscribe-footer), the default footer is translated into each recipient's language, so a German recipient sees "Abmelden" rather than "Unsubscribe".
