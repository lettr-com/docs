...
You can view delivery history for each webhook in the Lettr dashboard:

1. Navigate to **Settings** -> **Webhooks**
2. Select a webhook
3. View the delivery log showing recent attempts, response codes, and failure reasons
...
When a webhook is auto-disabled, you'll see it in the dashboard and can re-enable it after fixing the issue. Navigate to **Settings** -> **Webhooks**, select the disabled webhook, and toggle it back on.
