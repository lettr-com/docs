---
title: Authorization
description: "Secure your Lettr webhook endpoints with none, basic, or OAuth 2.0 authentication so only Lettr can deliver events to your server."
---
