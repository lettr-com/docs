...
<Note>
  A `delivered` status means the recipient's mail server accepted the email. It doesn't guarantee the email reached the inbox—it could be filtered to spam or quarantined by the recipient's email provider.
</Note>
