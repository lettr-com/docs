...
- **Products** and **Carousel** blocks. Their content is the same in every language, so keep customer-facing text out of them in a multilingual template, or use Text and Image blocks instead.
...
- Language changes live in your editing session until you click **Save**. **Undo** reverts them like any other edit, including adding or deleting a language.
