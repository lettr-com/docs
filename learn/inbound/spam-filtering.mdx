...
description: "Score and filter spam in incoming emails by analyzing content, headers, and sender reputation in your Lettr webhook handler"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Best Practices" icon="star" href="/learn/inbound/best-practices">
    Overall inbound best practices
  </Card>
</CardGroup>
