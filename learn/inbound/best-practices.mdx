...
description: "Best practices for processing inbound email with Lettr, including async webhook handling, to build reliable and secure pipelines."
---
...
<CardGroup cols={2}>
  <Card title="Setup" icon="gear" href="/learn/inbound/setup">
