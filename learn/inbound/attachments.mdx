---
title: Attachments
description: "Handle file attachments on inbound emails in Lettr, which extracts each file and provides a secure temporary URL to download it."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Security" icon="shield" href="/learn/inbound/security">
