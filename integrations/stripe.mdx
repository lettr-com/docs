---
title: "Stripe Email Integration"
description: "Install the Lettr Stripe app to send emails and saved templates to customers directly from the Stripe dashboard, with no code required."
---
