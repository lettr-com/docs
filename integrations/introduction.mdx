---
title: Introduction
description: "Connect Lettr to platforms like Stripe, Supabase, WordPress, and Zapier for email delivery via SMTP, the HTTP API, or Edge Functions."
---
...
<CardGroup cols={2}>
  ...
  <Card title="WordPress" icon="wordpress" href="/integrations/wordpress">
    Replace wp_mail with Lettr for reliable email delivery from WordPress
  </Card>
