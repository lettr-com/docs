...
description: "Diagnose and fix emails landing in spam, working through authentication, sender reputation, and content checks to reach the inbox"
---
...
<Tip>
  [Adamko](/learn/ai-assistant/content-creation#template-review) checks most of these triggers automatically: ask him to *review* a template before a big send and he flags shouting subject lines, image-only bodies, URL shorteners, `http://` links, and missing unsubscribe elements — each with a fix.
</Tip>
