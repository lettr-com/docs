---
title: Rate Limits
description: "Understand Lettr API rate limits and monthly quotas, handle 429 responses, and adjust your sending to avoid hitting thresholds"
---
...
<CardGroup cols={3}>
  <Card title="Rate Limits Reference" icon="gauge" href="/api-reference/rate-limit">
