...
- Use absolute URLs for image sources (Lettr's [email storage](/learn/email-storage/introduction) provides reliable hosting for email assets)
...
<CardGroup cols={2}>
  <Card title="Template Best Practices" icon="star" href="/knowledge-base/best-practices/templates">
    Guidelines for building maintainable, high-performing email templates.
  </Card>
  ...
  <Card title="Email Storage" icon="cloud" href="/learn/email-storage/introduction">
    Host images and assets for your emails with Lettr's CDN-backed storage.
  </Card>
</CardGroup>
