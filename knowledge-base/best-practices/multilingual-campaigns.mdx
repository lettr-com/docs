...
Lettr translates the automatic unsubscribe footer into 19 languages. A custom footer needs translating in every version. The hosted unsubscribe and preferences page behind the link is translated as well: it opens in the contact's language, or in your team's default communication language when the contact's language is not one of the 19. Set that default under **Settings** → **Team** to the language most of your audience reads.
...
- the unsubscribe link opening the preferences page in the right language,
