...
description: "Protect your Lettr account, API keys, and email data by storing keys in environment variables, securing webhooks, and limiting key permissions."
---
