...
<Tip>
  Most of the transactional types above — invoice, failed payment, card expiring, and the subscription lifecycle emails — are in [Adamko's scaffolding catalog](/learn/ai-assistant/content-creation#transactional-templates). Lettr's AI assistant can create the full branded set in one confirmation, skipping any you already have.
</Tip>
