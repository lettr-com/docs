...
<Tip>
  Don't want to design the welcome email from scratch? [Adamko](/learn/ai-assistant/content-creation#transactional-templates), Lettr's AI assistant, scaffolds a branded welcome template in about a minute — your logo, colors, and tone, pulled from your brand kit — ready to customize and send.
</Tip>
