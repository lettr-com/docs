...
<Tip>
  [Adamko](/learn/ai-assistant/content-creation#transactional-templates), Lettr's AI assistant, can scaffold a branded password reset template for you — ask *"create a password reset email"* and it arrives in your brand design with the reset-link merge tag in place, ready for the token your backend generates.
</Tip>
