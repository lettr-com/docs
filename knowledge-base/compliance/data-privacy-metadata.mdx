...
description: "What data Lettr stores when you send an email, the difference between metadata and substitution data, and how to protect sensitive information."
---
...
<AccordionGroup>
  ...
  <Accordion title="Don't store PII in tag or custom headers">
