---
title: Introduction
description: "The Lettr Knowledge Base: email fundamentals, deliverability best practices, troubleshooting, and compliance guides for reliable sending."
---
...
- [Multilingual Email Campaigns](/knowledge-base/best-practices/multilingual-campaigns) — Collect and clean language data, choose the fallback deliberately, translate the subject and sender
...
- [Adamko in Action: Real-World Scenarios](/knowledge-base/use-cases/adamko-in-action) — Seven worked examples of solving everyday email problems with Lettr's AI assistant
- [Multilingual Newsletter](/knowledge-base/use-cases/multilingual-newsletter) — One campaign in German, French and English to an audience with messy language data
