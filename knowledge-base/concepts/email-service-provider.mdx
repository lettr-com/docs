...
description: "What an email service provider does, how it differs from an ISP, and why sending through a dedicated provider like Lettr beats sending from your own server"
---
