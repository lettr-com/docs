...
This guide walks you through adding the required DNS records for Lettr using Squarespace's DNS management. Squarespace is a website builder and hosting platform that also offers DNS hosting for domains managed through its [Squarespace Domains panel](https://www.squarespace.com).
...
Log in to your [Squarespace account](https://www.squarespace.com) and navigate to your domain's settings. Go to the **Custom records** section where you can add DNS records.

{/* TODO: Add screenshot of Squarespace Custom records section */}
...
{/* TODO: Add screenshot of Squarespace nameserver configuration inside the accordion above */}
...
1. Click **Add custom record** in the Custom records section.
...
{/* TODO: Add screenshot of CNAME record in Squarespace */}

<Info>
  Squarespace automatically appends your domain to the record name. Always paste only the subdomain portion (e.g.
...
{/* TODO: Add screenshot of DKIM TXT record in Squarespace */}
...
4. Copy the **Value** from Lettr and paste it into the **Value** field (e.g. `v=DMARC1;p=none;`).
5. Click **Save**.


{/* TODO: Add screenshot of DMARC TXT record in Squarespace */}
...
{/* TODO: Add screenshot of MX records in Squarespace */}
...
{/* TODO: Add screenshot of SSL Certificate CNAME record in Squarespace */}
...
{/* TODO: Add screenshot of Traffic CNAME record in Squarespace */}
...
{/* TODO: Add screenshot of Certificate Validation TXT record in Squarespace */}
...
{/* TODO: Add screenshot of Hostname Pre-validation TXT record in Squarespace */}
...
{/* TODO: Add screenshot of Domain Routing CNAME record in Squarespace */}
...
<AccordionGroup>
  <Accordion title="Records Not Propagating">
    Squarespace DNS propagation can take up to 72 hours. If verification fails after adding records, check the following:
  ...
  <Accordion title="Cannot Add Custom Records">
    ...
    to Squarespace or using a different DNS provider.
  </Accordion>
  ...
  <Accordion title="DKIM Value Truncated">
    The DKIM TXT value is a long string. After saving the record, re-open the custom records section and confirm the full
