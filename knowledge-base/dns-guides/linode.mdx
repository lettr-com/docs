---
title: "Linode DNS Setup"
description: "Add the DNS records Lettr needs in Linode DNS Manager to verify your sending, inbound, tracking, and storage domains with DKIM and DMARC."
---
