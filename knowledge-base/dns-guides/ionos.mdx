---
title: "IONOS"
description: "Step-by-step guide to configuring DNS records for Lettr on IONOS."
---

This guide walks you through adding the required DNS records for Lettr using IONOS's DNS management. IONOS is a web hosting and domain provider that offers DNS hosting for domains managed through its [IONOS Control Panel](https://www.ionos.com).
...
Log in to the [IONOS Control Panel](https://www.ionos.com) and navigate to **Domains** → **DNS**. Select the domain you want to configure and access its DNS settings.

{/* TODO: Add screenshot of IONOS DNS management page */}
...
<AccordionGroup>
  <Accordion title="Domain registered with a different registrar?">
    ...
    at your registrar to IONOS's nameservers shown in your domain configuration.

    <Warning>Until the nameservers are updated, any records you add in IONOS will not resolve.</Warning>
  </Accordion>
</AccordionGroup>

{/* TODO: Add screenshot of IONOS nameserver configuration inside the accordion above */}
...
{/* TODO: Add screenshot of CNAME record in IONOS */}

<Info>
  IONOS automatically appends your domain to the record name. Always paste only the subdomain portion (e.g.
...
{/* TODO: Add screenshot of DKIM TXT record in IONOS */}
...
{/* TODO: Add screenshot of DMARC TXT record in IONOS */}
...
{/* TODO: Add screenshot of MX records in IONOS */}
...
{/* TODO: Add screenshot of SSL Certificate CNAME record in IONOS */}
...
{/* TODO: Add screenshot of Traffic CNAME record in IONOS */}
...
{/* TODO: Add screenshot of Certificate Validation TXT record in IONOS */}
...
{/* TODO: Add screenshot of Hostname Pre-validation TXT record in IONOS */}
...
{/* TODO: Add screenshot of Domain Routing CNAME record in IONOS */}
...
<AccordionGroup>
  <Accordion title="Records Not Propagating">
    IONOS DNS may take up to 48 hours to propagate in some cases. If verification fails after adding records, check the
    following:
  ...
  <Accordion title="Nameservers Not Pointing to IONOS">
    ...
    The output should include IONOS nameservers. If it shows a different provider's nameservers, update them in your domain
    registrar settings.
  </Accordion>
