---
title: "DigitalOcean"
description: "Add the DNS records Lettr needs in the DigitalOcean control panel to verify your sending, inbound, tracking, and storage domains with DKIM and DMARC."
---
...
<AccordionGroup>
  <Accordion title="Domain registered with a different registrar?">
    ...
    <img src="/images/ocean-nameservers.png" alt="DigitalOcean DNS zone overview showing nameserver records" />
...
<img src="/images/ocean-mailing-1.png" alt="DigitalOcean DNS record form for adding a sending domain CNAME record" />
...
<img src="/images/ocean-mailing-2.png" alt="DigitalOcean DNS record form for adding a DKIM TXT record" />
...
<img src="/images/ocean-mailing-3.png" alt="DigitalOcean DNS record form for adding a DMARC TXT record" />
...
<img src="/images/ocean-inbound.png" alt="DigitalOcean DNS record form for adding MX records for inbound mail" />
...
<img src="/images/ocean-tracking-1.png" alt="DigitalOcean DNS record form for adding MX records for inbound mail" />
...
<img src="/images/ocean-tracking-2.png" alt="DigitalOcean DNS record form for adding MX records for inbound mail" />
...
<img src="/images/ocean-storage-1.png" alt="DigitalOcean DNS record form for adding MX records for inbound mail" />
...
<img src="/images/ocean-storage-2.png" alt="DigitalOcean DNS record form for adding MX records for inbound mail" />
...
<img src="/images/ocean-storage-3.png" alt="DigitalOcean DNS record form for adding MX records for inbound mail" />
