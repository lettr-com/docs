...
description: "Configure Vercel DNS for Lettr: add CNAME, DKIM, DMARC, and MX records to set up sending, inbound, tracking, and storage domains."
---
...
<img src="/images/vercel-domain-list.png" alt="Domain list in Vercel project dashboard" />
