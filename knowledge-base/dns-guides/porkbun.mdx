---
title: "Porkbun"
description: "Configure Porkbun DNS for Lettr: add CNAME, DKIM, DMARC, and MX records to set up sending, inbound, tracking, and storage domains."
---
...
<AccordionGroup>
  <Accordion title="Host Field Auto-appends Domain">
