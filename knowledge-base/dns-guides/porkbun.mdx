---
title: "Porkbun"
description: "Step-by-step guide to configuring DNS records for Lettr on Porkbun."
---
...
Log in to your [Porkbun dashboard](https://porkbun.com) and navigate to your domain. Click **DNS** to access the DNS record management page.

{/* TODO: Add screenshot of Porkbun DNS management page */}
...
<AccordionGroup>
  <Accordion title="Domain registered with a different registrar?">
    ...
    <Warning>Until the nameservers are updated, any records you add in Porkbun will not resolve.</Warning>
  </Accordion>
</AccordionGroup>

{/* TODO: Add screenshot of Porkbun nameserver configuration inside the accordion above */}
...
1. In the DNS management page, select **CNAME** from the **Record Type** dropdown.
2. Copy the **Hostname** from Lettr and paste it into the **Subdomain** field (without your domain suffix). For example, paste only `mailing`.
3. Copy the **Value** from Lettr and paste it into the **Content** field.
4. Leave **TTL** at the default or set to **3600**.
5. Click **Create Record**.

<img src="/images/lettr-mailing-1.png" alt="CNAME record Hostname and Value in Lettr" />

{/* TODO: Add screenshot of CNAME record in Porkbun */}

<Info>
  Porkbun automatically appends your domain to the subdomain field. Always paste only the subdomain portion (e.g.
...
1. In the DNS management page, select **TXT** from the **Record Type** dropdown.
2. Copy the **Hostname** from Lettr and paste it into the **Subdomain** field (without your domain suffix). For example, paste only `scph0126._domainkey.mailing`.
3. Copy the **Value** from Lettr and paste it into the **Content** field.
4. Leave **TTL** at the default or set to **3600**.
5. Click **Create Record**.
...
{/* TODO: Add screenshot of DKIM TXT record in Porkbun */}
...
1. In the DNS management page, select **TXT** from the **Record Type** dropdown.
2. Copy the **Hostname** from Lettr and paste it into the **Subdomain** field (without your domain suffix). For example, paste only `_dmarc.mailing`.
3. Copy the **Value** from Lettr and paste it into the **Content** field.
4. Leave **TTL** at the default or set to **3600**.
5. Click **Create Record**.
...
{/* TODO: Add screenshot of DMARC TXT record in Porkbun */}
...
1. In the DNS management page, select **MX** from the **Record Type** dropdown.
2. Copy the **Hostname** from Lettr and paste it into the **Subdomain** field (without your domain suffix). For example, paste only `inbound`.
3. Copy the first MX record value from Lettr (e.g. `rx1.sparkpostmail.com`) and paste it into the **Content** field.
4. Set **Priority** to `10`.
5. Leave **TTL** at the default or set to **3600**.
...
{/* TODO: Add screenshot of MX records in Porkbun */}
...
1. In the DNS management page, select **CNAME** from the **Record Type** dropdown.
2. Copy the **Hostname** from Lettr and paste it into the **Subdomain** field (without your domain suffix).
3. Copy the **Value** from Lettr and paste it into the **Content** field.
4. Click **Create Record**.

<img src="/images/lettr-tracking-1.png" alt="SSL Certificate CNAME record values in Lettr for tracking domain" />

{/* TODO: Add screenshot of SSL Certificate CNAME record in Porkbun */}
...
{/* TODO: Add screenshot of Traffic CNAME record in Porkbun */}
...
{/* TODO: Add screenshot of Certificate Validation TXT record in Porkbun */}
...
{/* TODO: Add screenshot of Hostname Pre-validation TXT record in Porkbun */}
...
{/* TODO: Add screenshot of Domain Routing CNAME record in Porkbun */}
...
<AccordionGroup>
  <Accordion title="Records Not Propagating">
    Porkbun DNS propagation can take several hours. If verification fails after adding records, check the following:
  ...
  <Accordion title="Nameservers Not Pointing to Porkbun">
    If your records are saved in Porkbun but not resolving, confirm that your domain is using Porkbun's nameservers. You can
    check this with:
    ...
    The output should include Porkbun nameservers. If it shows a different provider's nameservers, update them in your
    domain registrar settings.
  </Accordion>
  <Accordion title="Wrong Record Type">
    A common mistake is selecting the wrong record type from the dropdown:
