...
{/* TODO: Add screenshot of Namecheap Advanced DNS page */}
...
{/* TODO: Add screenshot of Namecheap nameserver configuration inside the accordion above */}
...
{/* TODO: Add screenshot of CNAME record in Namecheap */}
...
{/* TODO: Add screenshot of DKIM TXT record in Namecheap */}
...
{/* TODO: Add screenshot of DMARC TXT record in Namecheap */}
...
Before adding MX records, ensure that Namecheap's **Mail Settings** for your domain are set to **Custom MX**. Otherwise, Namecheap's default MX records will take precedence.
...
{/* TODO: Add screenshot of MX records in Namecheap */}
...
{/* TODO: Add screenshot of SSL Certificate CNAME record in Namecheap */}
...
{/* TODO: Add screenshot of Traffic CNAME record in Namecheap */}
...
{/* TODO: Add screenshot of Certificate Validation TXT record in Namecheap */}
...
{/* TODO: Add screenshot of Hostname Pre-validation TXT record in Namecheap */}
...
{/* TODO: Add screenshot of Domain Routing CNAME record in Namecheap */}
...
<AccordionGroup>
  <Accordion title="Host Values Include Full Domain">
  ...
  <Accordion title="MX Records Not Working">
    If your inbound MX records are not resolving, check that Namecheap's **Mail Settings** for your domain are set to
    **Custom MX**. Navigate to your domain's **Email** tab and change the mail settings. Default MX records will override
    any custom MX records you add.
  </Accordion>
  ...
  <Accordion title="DKIM Value Truncated">
    The DKIM TXT value is a long string. After saving the record, click **Edit** to confirm the full value was stored in the
    Value field. If it appears truncated, delete the record and re-add it, pasting the full value carefully.
  </Accordion>
