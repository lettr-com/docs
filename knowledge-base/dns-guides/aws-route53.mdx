...
<img src="/images/route-domain-list.png" alt="Hosted zones list in AWS Route 53 dashboard" />

This will open the Hosted zone details page, where you can manage your DNS records.

<img src="/images/route-domain-config.png" alt="Hosted zone details page in AWS Route 53" />
...
<AccordionGroup>
  <Accordion title="Domain registered with a different registrar?">
    ...
    <img src="/images/route-nameservers.png" alt="AWS Route 53 nameserver configuration" />
...
<img src="/images/route-sending-1.png" alt="Adding CNAME record in AWS Route 53" />
...
<img src="/images/route-sending-2.png" alt="Adding DKIM TXT record in AWS Route 53" />
...
<img src="/images/route-sending-3.png" alt="Adding DMARC TXT record in AWS Route 53" />
...
<img src="/images/route-inbound-1.png" alt="Adding MX records in AWS Route 53" />
...
Click on the name of your new tracking domain in the Tracking Domains list.
...
<img src="/images/route-tracking-1.png" alt="Adding SSL Certificate CNAME record in AWS Route 53" />
...
<img src="/images/route-tracking-2.png" alt="Adding Traffic CNAME record in AWS Route 53" />
...
<img src="/images/route-storage-1.png" alt="Adding Certificate Validation TXT record in AWS Route 53" />
...
<img src="/images/route-storage-2.png" alt="Adding Hostname Pre-validation TXT record in AWS Route 53" />
...
<img src="/images/route-storage-3.png" alt="Adding Domain Routing CNAME record in AWS Route 53" />
