...
<img src="/images/route-domain-list.png" alt="CNAME record Hostname and Value in Lettr" />

This will open the Hosted zone details page, where you can manage your DNS records.

<img src="/images/route-domain-config.png" alt="CNAME record Hostname and Value in Lettr" />
...
<AccordionGroup>
  <Accordion title="Domain registered with a different registrar?">
    ...
    <img src="/images/route-nameservers.png" alt="Vercel nameserver configuration options" />
    <Warning>Until the nameservers are updated, any records you add in AWS Route 53 will not resolve.</Warning>
  </Accordion>
</AccordionGroup>
...
<img src="/images/route-sending-1.png" alt="CNAME record Hostname and Value in Lettr" />
...
<img src="/images/route-sending-2.png" alt="DKIM TXT record Hostname and Value in Lettr" />
...
<img src="/images/route-sending-3.png" alt="DMARC TXT record Hostname and Value in Lettr" />
...
<img src="/images/lettr-inbound-list.png" alt="Inbound domain listed in Lettr domain list" />
...
<img src="/images/route-inbound-1.png" alt="MX record values in Lettr for inbound domain" />
...
<img src="/images/route-tracking-1.png" alt="SSL Certificate CNAME record values in Lettr for tracking domain" />
...
<img src="/images/route-tracking-2.png" alt="Traffic CNAME record values in Lettr for tracking domain" />
...
<img src="/images/lettr-storage-list.png" alt="Storage domain listed in Lettr domain list" />
...
<img src="/images/route-storage-1.png" alt="Certificate Validation TXT record values in Lettr for storage domain" />
...
<img src="/images/route-storage-2.png" alt="Hostname Pre-validation TXT record values in Lettr for storage domain" />
...
<img src="/images/route-storage-3.png" alt="Domain Routing CNAME record values in Lettr for storage domain" />
